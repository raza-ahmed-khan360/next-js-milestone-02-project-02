            ...
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  appealing. Using the latest web technologies, I ensure that
                  every website I develop performs seamlessly across devices,
                  providing an engaging experience for every visitor.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  experiences. I focus on designing interfaces that are not only
                  visually engaging but also easy to navigate, ensuring users
                  feel guided and valued every step of the way.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  effectively. From branding to social media graphics, my
                  designs are crafted to captivate and resonate with the target
                  audience, ensuring each piece is both beautiful and
                  purposeful.
                </p>
              </div>
            </div>
